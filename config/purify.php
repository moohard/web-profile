    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            'Core.Encoding' => 'utf-8',
            'HTML.Doctype' => 'HTML 4.01 Transitional',
            'HTML.Allowed' => 'h1,h2,h3,h4,h5,h6,b,u,strong,i,em,s,del,a[href|title],ul,ol,li,p,br,span,img[width|height|alt|src],blockquote',
            'HTML.ForbiddenElements' => '',
            // CSS.AllowedProperties kosong + tanpa [style] di HTML.Allowed =
            // seluruh atribut style inline dibuang (rich-text Tiptap tak butuh
            // inline CSS; design system di-handle class pada profil cms_page).
        ...
        'cms_page' => [
            'Core.Encoding' => 'utf-8',
            'HTML.Doctype' => 'HTML 4.01 Transitional',
            // Hanya HTML.Allowed (tag[attr]) — jangan set HTML.AllowedAttributes terpisah
            // agar allowlist elemen tetap efektif.
            'HTML.Allowed' => implode(',', [
                'div[class]',
                'section[class]',
                'span[class]',
                ...
                'tbody[class]',
                'tr[class]',
                'td[class|width|height]',
                'th[class|width|height]',
                'strong[class]',
                'em[class]',
                'b[class]',
                'i[class]',
