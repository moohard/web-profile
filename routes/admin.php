...
Route::prefix('posts')->name('posts.')->group(function (): void {
    ...
    Route::delete('/{post}/force', [PostController::class, 'forceDelete'])->name('forceDelete')->withTrashed();
});
...
Route::prefix('pages')->name('pages.')->group(function (): void {
    ...
    Route::delete('/{page}/force', [PageController::class, 'forceDelete'])->name('forceDelete')->withTrashed();
});
